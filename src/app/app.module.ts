  ...
  imports: [
    ...
    JwtModule.forRoot({
      config: {
         ...
         whitelistedDomains: ['localhost:5000', 'localhost:44331', 'https://contactviewapi.herokuapp.com'],
         blacklistedRoutes: ['localhost:5000/api/auth', 'localhost:44331/api/auth', 'https://contactviewapi.herokuapp.com/api/auth']
      }
   })
  ],
  providers: [
